...
class DebertaV2ForTokenClassificationWithBiaffine(DebertaV2PreTrainedModel):
...
# Copied from transformers.models.deberta.modeling_deberta.DebertaForTokenClassification with Deberta->DebertaV2
class DebertaV2ForTokenClassificationWithGlobalPointer(DebertaV2PreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
