...
class RobertaForTokenClassificationWithBiaffine(RobertaPreTrainedModel):
...
class RobertaForTokenClassificationWithGlobalPointer(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
