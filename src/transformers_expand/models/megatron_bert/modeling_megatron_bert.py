...
@add_start_docstrings(
    """
    MegatronBert Model with a token classification head on top (a biaffine layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    MEGATRON_BERT_START_DOCSTRING,
)
class MegatronBertForTokenClassificationWithBiaffine(MegatronBertPreTrainedModel):
...
@add_start_docstrings(
    """
    MegatronBert Model with a token classification head on top (a global pointer layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    MEGATRON_BERT_START_DOCSTRING,
)
class MegatronBertForTokenClassificationWithGlobalPointer(MegatronBertPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
