...
class Data2VecTextForTokenClassificationWithBiaffine(Data2VecTextPreTrainedModel):
...
class Data2VecTextForTokenClassificationWithGlobalPointer(Data2VecTextPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
    _keys_to_ignore_on_load_missing = [r"position_ids"]
