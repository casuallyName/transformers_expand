...
@add_start_docstrings(
    """
    Longformer Model with a token classification head on top (a biaffine layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    LONGFORMER_START_DOCSTRING,
)
class LongformerForTokenClassificationWithBiaffine(LongformerPreTrainedModel):
...
@add_start_docstrings(
    """
    Longformer Model with a token classification head on top (a global pointer layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    LONGFORMER_START_DOCSTRING,
)
class LongformerForTokenClassificationWithGlobalPointer(LongformerPreTrainedModel):
    _keys_to_ignore_on_load_unexpected = [r"pooler"]
