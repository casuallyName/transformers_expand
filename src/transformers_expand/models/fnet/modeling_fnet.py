...
@add_start_docstrings(
    """
    FNet Model with a token classification head on top (a biaffine layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    FNET_START_DOCSTRING,
)
class FNetForTokenClassificationWithBiaffine(FNetPreTrainedModel):
...
@add_start_docstrings(
    """
    FNet Model with a token classification head on top (a global pointer layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    FNET_START_DOCSTRING,
)
class FNetForTokenClassificationWithGlobalPointer(FNetPreTrainedModel):
