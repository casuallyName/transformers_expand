...
@add_start_docstrings(
    """
    The LUKE Model with a token classification head on top (a biaffine layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    LUKE_START_DOCSTRING,
)
class LukeForTokenClassificationWithBiaffine(LukePreTrainedModel):
...
@add_start_docstrings(
    """
    The LUKE Model with a token classification head on top (a global pointer layer on top of the hidden-states output) 
    e.g. for Named-Entity-Recognition (NER) tasks.
    """,
    LUKE_START_DOCSTRING,
)
class LukeForTokenClassificationWithGlobalPointer(LukePreTrainedModel):
